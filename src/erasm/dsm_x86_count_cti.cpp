...
struct Counter
{
   ...
   template<class Insn>
   action_result_type
   action(const Insn& insn,rel8_t rel)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   template<class Insn>
   action_result_type
   action(const Insn& insn,rel16_t rel)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   template<class Insn>
   action_result_type
   action(const Insn& insn,rel32_t rel)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   action_result_type
   action(const Jmp& insn,const rel8_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   action_result_type
   action(const Jmp& insn,const rel16_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   action_result_type
   action(const Jmp& insn,const rel32_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   action_result_type
   action(const Call& insn,const rel16_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   action_result_type
   action(const Call& insn,const rel32_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   template<class Op>
   action_result_type
   action(const Call& insn,const Op& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   action_result_type
   action(const Ret& insn,const rel8_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   action_result_type
   action(const Ret& insn,const rel16_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   action_result_type
   action(const Ret& insn,const rel32_t& op)
      {
	 counter ++;
	 return check(insn);
      }
   ...
   template<class Op>
   action_result_type
   action(const Ret& insn,const Op& op)
      {
	 counter ++;
	 return check(insn);
      }
