#ifndef ERASM_X86_INSTRUCTION_DEFINITION_HPP
#define ERASM_X86_INSTRUCTION_DEFINITION_HPP
/* DO NOT EDIT! 
...
#include "erasm/x86_instruction_definition_common.hpp"
namespace erasm {
namespace x86 {
...
struct Aaa : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
struct Aad : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
struct Aam : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
struct Aas : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
...
struct Daa : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
struct Das : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
...
struct Popa : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
struct Popad : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
...
struct Pusha : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
struct Pushad : InstructionData
{
   static
    const char (* const  mnemonic);
} ;
