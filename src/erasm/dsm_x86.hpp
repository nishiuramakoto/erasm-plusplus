...
#ifndef MY_ERASM_DSM_X86_HPP
#define MY_ERASM_DSM_X86_HPP


#include "erasm/x86_instruction_definition.hpp"
...
struct  OpRM8
{
   ...
   typedef ByteReg reg_operand_type;
...
struct OpFar16 
{
   typedef FarPtr16 operand_type;
};

struct OpFar32 
{
   typedef FarPtr32 operand_type;
};


struct  OpMOffs8
{
   typedef ByteOffset16 offset16_type;
   typedef ByteOffset32 offset32_type;
};

struct OpMOffs16
{
   typedef WordOffset16 offset16_type;
   typedef WordOffset32 offset32_type;
};
struct  OpMOffs32
{
   typedef DwordOffset16 offset16_type;
...
struct  OpM8_DS_BX_EBX_RBX
{
   ...
   typedef BytePtr_BX ptr_bx_type;
};
...
{ return ModrmConstHandle(p,ADDRESS_MODE_32).get_mod() ; }

inline bool modrm_mod3(const_code_pointer_type p)
{ return ModrmConstHandle(p,ADDRESS_MODE_32).get_mod() == 3; }

inline unsigned int modrm_reg_op(const_code_pointer_type p)
{ return ModrmConstHandle(p,ADDRESS_MODE_32).get_op_reg() ; }

inline unsigned int modrm_rm(const_code_pointer_type p)
{ return ModrmConstHandle(p,ADDRESS_MODE_32).get_rm() ; }

inline unsigned int imm(const_code_pointer_type p,bool addr32)
{    
   int n = ModrmConstHandle(p,ADDRESS_MODE_32).size();
   return p[n];
}
...
struct DispatcherHelper
{
   ...
   DispatcherHelper(Action& action,InstructionData& params) 
	...
	// (it must have no run-time overhead,of course)
   ...
   template<class Moffs>
   Moffs decode_moffset16() 
      {
	 return Moffs(decode_imm<imm16_t>(),
		      get_segment());
      }
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   DispatcherHelperModrm(Action& action,InstructionData& params) 
      : base(action,params) 
      , modrm(params.end,params.is_addr32 ? ADDRESS_MODE_32 : ADDRESS_MODE_16)
      {
	 base::p += modrm.size();
      }
   ...
   modrm_ptr_operand_type get_modrm_ptr_operand() const 
      {
	 return modrm_ptr_operand_type(modrm,base::get_segment());
      }
   ...
   : public DispatcherHelperModrm<Action,Insn,RM>
{
   ...
   action_result_type action() 
	 ...
	 op2_type op2(base::modrm.get_op_reg());
   ...
   : public DispatcherHelperModrm<Action,Insn,RM>
{
   ...
   action_result_type action() 
	 ...
	 op1_type op1(base::modrm.get_op_reg());
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   action_result_type action() 
	 ...
	 typedef typename MOff::offset16_type offset16_type;
	 ...
	 if (base::is_addr32()) {
	    ...
	    offset16_type op2 = 
	       base::template decode_moffset16<offset16_type>();
	    return base::dispatch(op1,op2);
	 }
      }
};
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   action_result_type action() 
	 ...
	 if (base::is_addr32()) {
	    ...
	    return base::dispatch(ptr_bx_type(base::get_segment()));
	 }
      }
};
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   action_result_type action() 
	 ...
	 typedef typename DS_ESI::ptr_si_type ptr_si_type;

	 typedef typename ES_EDI::ptr_es_edi_type ptr_es_edi;
	 typedef typename ES_EDI::ptr_es_di_type ptr_es_di;

	 if (base::is_addr32()) {
	    return base::dispatch(ptr_esi_type(base::get_segment()),
				  ptr_es_edi());
	 } else {
	    return base::dispatch(ptr_si_type(base::get_segment()),
				  ptr_es_di());
	 }
      }
};
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   action_result_type action() 
	 ...
	 if (base::is_addr32()) {
	    ...
	    return base::dispatch(ptr_es_di(),
				  ptr_si_type(base::get_segment()));
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   action_result_type action() 
	 ...
	 typedef typename M::ptr_es_di_type ptr16_type;
	 ...
	 if (base::is_addr32()) {
	    ...
	    return base::dispatch(ptr16_type(),op2);
	 }
      }
};
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   action_result_type action() 
	 ...
	 if (base::is_addr32()) {
	    ...
	    return base::dispatch(op1,ptr16_type());
	 }
      }
};
   ...
   : public DispatcherHelper<Action,Insn>
{
   ...
   action_result_type action() 
	 ...
	 typedef typename M::ptr_si_type ptr16_type;
	 ...
	 if (base::is_addr32()) {
	    ...
	    return base::dispatch(op1,ptr16_type(base::get_segment()));
	 }
      }
};
...
template<class Action,
	 bool Default_addressing_mode_is_32bit,
...
decode(const_code_pointer_type decode_start,Action & action)
{
   ...
   while (action_code == ACTION_CONTINUE) {
      ...
      is_addr32 =   Default_addressing_mode_is_32bit;

     decode_start:
#include "erasm/dsm_x86_auto_stm.hpp"
