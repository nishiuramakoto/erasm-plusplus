...
p += adc(p,byte_ptr[bx+si + (imm8_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bx+di + (imm8_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bp+si + (imm8_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bp+di + (imm8_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[si    + (imm8_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[di    + (imm8_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bp    + (imm8_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bx    + (imm8_t)0x1],(imm8_t)0x12);

p += adc(p,byte_ptr[bx+si + (imm16_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bx+di + (imm16_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bp+si + (imm16_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bp+di + (imm16_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[si    + (imm16_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[di    + (imm16_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bp    + (imm16_t)0x1],(imm8_t)0x12);
p += adc(p,byte_ptr[bx    + (imm16_t)0x1],(imm8_t)0x12);


p += adc(p,cx,(imm8_t)0x12);
p += adc(p,word_ptr[ebx],(imm8_t)0x12);
p += adc(p,word_ptr[bx],(imm8_t)0x12);
p += adc(p,dword_ptr[eax],1);
p += adc(p,cl,bh);
p += adc(p,cx,bx);
p += adc(p,ecx,edx);
p += addpd(p,xmm1,xmm7);
...
p += call(p,(imm16_t)0x1234);
p += call(p,(imm32_t)0x12345678);
p += call(p,ax);
